...
namespace SM64Lib.Patching
{
    public class PatchingManager
    {
        ...
        public PatchScriptResult Patch(PatchScript script, IReadOnlyDictionary<string, object> @params, string[] additionalAssemblyReferences, bool createUndoPatch = false)
        {
            return Patch(script, null, @params, additionalAssemblyReferences, false);
        }

        public PatchScriptResult Patch(PatchScript script, RomManager rommgr, IReadOnlyDictionary<string, object> @params, string[] additionalAssemblyReferences, bool createUndoPatch = false)
        {
            if (script is null)
